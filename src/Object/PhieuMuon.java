...
public class PhieuMuon {
    ...
    public PhieuMuon(String maMuon, String maKhach, String maSach, String name, Date ngayMuon, Date hanTra, Date ngayTra, float tienCoc) {
        this.maMuon = maMuon;
    ...
    public PhieuMuon(String text, String text0, String text1, String text2, Date valueOf, Date valueOf0, Date valueOf1) {
